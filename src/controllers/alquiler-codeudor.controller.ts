...
export class AlquilerCodeudorController {
  ...
  async find(
    ...
    return this.alquilerRepository.codeudors(id).find(filter);
  }
  ...
  async create(
    ...
    return this.alquilerRepository.codeudors(id).create(codeudor);
  }
  ...
  async patch(
    ...
    return this.alquilerRepository.codeudors(id).patch(codeudor, where);
  }
  ...
  async delete(
    ...
    return this.alquilerRepository.codeudors(id).delete(where);
  }
}
